...
## [1.13.1](https://github.com/ubiquity-os-marketplace/command-start-stop/compare/v1.13.0...v1.13.1) (2026-04-22)


### Bug Fixes

* add BOT_USER_ID to update-configuration workflow environment ([c2bed3a](https://github.com/ubiquity-os-marketplace/command-start-stop/commit/c2bed3ad640fb1c8b81ab978953879f50b7a57b4))
* added runtime manifest to resolve homepage_url ([0a998a4](https://github.com/ubiquity-os-marketplace/command-start-stop/commit/0a998a420d90bf19e041ed2945dd254586540f89))
...
* **ci:** treat demo as production secrets environment ([8d91bb1](https://github.com/ubiquity-os-marketplace/command-start-stop/commit/8d91bb15934ed527ee7ca9fa848439909082a802))
* close invalid contributor PRs without valid issues ([ea45a71](https://github.com/ubiquity-os-marketplace/command-start-stop/commit/ea45a71bf556e93c5c864a0157de28034e5f063d))
* close invalid contributor pull requests ([e710efb](https://github.com/ubiquity-os-marketplace/command-start-stop/commit/e710efb0ebebb60d0cced3ae53b8dc262518a166))
* close PRs on rejected PR-triggered starts ([#218](https://github.com/ubiquity-os-marketplace/command-start-stop/issues/218)) ([e6103a4](https://github.com/ubiquity-os-marketplace/command-start-stop/commit/e6103a4b37665c7a7ce6200f34ea3892a28489fb))
* deno environment is properly read ([c9237c7](https://github.com/ubiquity-os-marketplace/command-start-stop/commit/c9237c7a2fdbc4d1ebd244d73d5050c1a53e7f41))
* fixed environment setting for Deno Deploy ([cd3dfa9](https://github.com/ubiquity-os-marketplace/command-start-stop/commit/cd3dfa9fd56b2d526007233bfa2e09ee7c84394f))
...
* preserve full runtime branch name ([accfe5e](https://github.com/ubiquity-os-marketplace/command-start-stop/commit/accfe5e17536e73dae6cf6a532840724d6c63224))
...
* serve runtime manifest metadata ([0ac8d64](https://github.com/ubiquity-os-marketplace/command-start-stop/commit/0ac8d649c911461f2507e3a1bcfdd3ec6c98ea48))
* simplify invalid PR warning ([49116e2](https://github.com/ubiquity-os-marketplace/command-start-stop/commit/49116e2eb6c392f2419c50d09c0b853e62f052f5))
...
* update default value for skipBotEvents in workflow configuration ([a7a47b6](https://github.com/ubiquity-os-marketplace/command-start-stop/commit/a7a47b6ef168870665397cc4c543c967b13a67a0))
* update Deno dev script and upgrade plugin-sdk dependency ([6f95c7c](https://github.com/ubiquity-os-marketplace/command-start-stop/commit/6f95c7c38742050be48cbf83a42ad8de4757ce9b))
* use graphql for linked pull requests ([#217](https://github.com/ubiquity-os-marketplace/command-start-stop/issues/217)) ([e95bd0a](https://github.com/ubiquity-os-marketplace/command-start-stop/commit/e95bd0a731f14b22c6fdbd2e53a32771cfcc0556))
* use runtime manifest ref env ([12aed7c](https://github.com/ubiquity-os-marketplace/command-start-stop/commit/12aed7c4104c0d1124e5ca229806fda6bf02ef52))
