...
/* harmony export */   "default": () => (/* binding */ getToOpenAPISchemaFn)
/* harmony export */ });
/* harmony import */ var _default_u_dwuiYb_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2200);
/* harmony import */ var _index_DZEfthgZ_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(5019);
/* harmony import */ var _standard_community_standard_json__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(8258);
...
function getToOpenAPISchemaFn() {
  return async (schema, context) => {
    ...
    try {
      const { createSchema } = await __webpack_require__.e(/* import() */ 563).then(__webpack_require__.t.bind(__webpack_require__, 1563, 19));
