...
function getToOpenAPISchemaFn() {
  return async (schema, context) => {
    const openapiSchema = await (0,_standard_community_standard_json__WEBPACK_IMPORTED_MODULE_0__/* .toJsonSchema */ .P)(schema, {
      errorMode: "ignore",
      // @ts-expect-error
      overrideAction: ({ valibotAction, jsonSchema }) => {
        const _jsonSchema = (0,_vendors_convert_js__WEBPACK_IMPORTED_MODULE_1__/* .convertToOpenAPISchema */ .k)(jsonSchema, context);
