...
async function getToJsonSchemaFn() {
  try {
    const { toJsonSchema } = await __webpack_require__.e(/* import() */ 524).then(__webpack_require__.bind(__webpack_require__, 8524));
    return toJsonSchema;
  } catch {
    throw new _index_CLddUTqr_js__WEBPACK_IMPORTED_MODULE_0__.M("@valibot/to-json-schema");
  }
}
