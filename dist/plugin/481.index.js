...
/* harmony export */ });
/* harmony import */ var _standard_community_standard_json__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(3539);
/* harmony import */ var _vendors_convert_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(9018);
...
/* harmony export */   "default": () => (/* binding */ getToOpenAPISchemaFn)
/* harmony export */ });
/* harmony import */ var _default_u_dwuiYb_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(9117);
/* harmony import */ var _index_DZEfthgZ_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(1074);
/* harmony import */ var _standard_community_standard_json__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(3539);
...
function getToOpenAPISchemaFn() {
  return async (schema, context) => {
    if ("_zod" in schema) {
      return (0,_default_u_dwuiYb_js__WEBPACK_IMPORTED_MODULE_0__["default"])()(schema, {
        components: context.components,
        options: { io: "input", ...context.options }
      });
    }
    try {
      const { createSchema } = await __webpack_require__.e(/* import() */ 916).then(__webpack_require__.t.bind(__webpack_require__, 9916, 19));
      ...
      throw new Error(
        (0,_index_DZEfthgZ_js__WEBPACK_IMPORTED_MODULE_1__.e)(`Missing dependencies "zod-openapi v4".`)
      );
    }
  };
}
